...
// double buffering
DVIGFX1 display(DVI_RES_320x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_400x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_400x240p30, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_640x480p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_800x480p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_800x480p30, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_640x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_800x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX1 display(DVI_RES_800x240p30, true, adafruit_lilygo_rp2350_cfg);
...
void loop()
{
    // Serial.println("PicoDVI framebuffer test");
    // delay(2000);
