...
DVIGFX8 display(DVI_RES_320x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX8 display(DVI_RES_400x240p60, true, adafruit_lilygo_rp2350_cfg);
// DVIGFX8 display(DVI_RES_400x240p30, true, adafruit_lilygo_rp2350_cfg);
