...
DVIGFX16 display(DVI_RES_320x240p60,adafruit_lilygo_rp2350_cfg);
// DVIGFX16 display(DVI_RES_400x240p30,adafruit_lilygo_rp2350_cfg);
// DVIGFX16 display(DVI_RES_400x240p60,adafruit_lilygo_rp2350_cfg);
// DVIGFX16 display(DVI_RES_640x480p60,adafruit_lilygo_rp2350_cfg);
...
void loop()
{
    // display.drawRect(0, 0, display.width(), display.height(), 0x00FF00);
    ...
    if (canvas16.getBuffer())
    {
        ...
        while ((elapsed = (millis() - startTime)) <= PAUSE * 2)
        {
            ...
            {                              // For each label...
                ...
                display.drawRGBBitmap(max_w + PADDING, i * FreeSansBold18pt7b.yAdvance + y_offset, canvas16.getBuffer(), canvas16.width(),
                                      canvas16.height());
            }
        }
    }
    else
    {
        ...
        while ((elapsed = (millis() - startTime)) <= PAUSE * 2)
        {
            for (uint8_t i = 0; i < 3; i++)
            {
                ...
                display.drawBitmap(max_w + PADDING, i * FreeSansBold18pt7b.yAdvance + y_offset, canvas1.getBuffer(), canvas1.width(),
